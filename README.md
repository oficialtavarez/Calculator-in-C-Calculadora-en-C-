...
NotAnotherAnimeTheme es un tema altamente personalizable para Discord (con [BetterDiscord] (https://github.com/rauenzi/BetterDiscordApp/releases/latest)) que permite una versión renovada y revitalizada de la interfaz de usuario de Discord. Cada parte del tema es personalizable, desde la imagen de fondo hasta los colores de la barra de desplazamiento. El usuario tiene control total sobre la configuración predeterminada. Se pueden encontrar imágenes de vista previa [aquí.] (Https://github.com/puckzxz/NotAnotherAnimeTheme#images-of-variations)
